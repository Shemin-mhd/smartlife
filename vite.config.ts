          ...
          req.on('end', async () => {
            try {
              ...
              if (inqData.id) {
                ...
                // Dispatch Email Notification via Brevo SMTP to sheminmuhammed594@gmail.com
                try {
                      ...
                      <div style="font-family: Arial, sans-serif; max-width: 580px; margin: 0 auto; padding: 24px; border: 1px solid #e2e8f0; border-radius: 12px; background: #ffffff;">
                        ...
                        <div style="padding: 20px; border: 1px solid #e2e8f0; border-top: none; border-radius: 0 0 8px 8px;">
                          <div style="background: #eff6ff; border-left: 4px solid #2563eb; padding: 12px 16px; margin-bottom: 16px;">
                            ...
                            <p style="margin: 4px 0 0 0; font-size: 12px; color: #475569;">Assigned Branch: ${inqData.assignedBranch || 'Abu Shagara Main Branch'}</p>
                          </div>
                          <table style="width: 100%; border-collapse: collapse; font-size: 13px; margin-bottom: 16px;">
                            ...
                            <tr>
                              ...
                              <td style="padding: 8px; color: #059669; font-weight: bold; border-bottom: 1px solid #f1f5f9;">${inqData.phone || 'N/A'}</td>
                            </tr>
                            <tr>
                              <td style="padding: 8px; font-weight: bold; color: #475569; border-bottom: 1px solid #f1f5f9;">Client Email:</td>
                              <td style="padding: 8px; color: #2563eb; font-weight: bold; border-bottom: 1px solid #f1f5f9;">${inqData.email || 'Not provided'}</td>
                            </tr>
                          </table>
                          ...
                          ${cleanPhone ? `<div style="text-align: center; margin-top: 20px;"><a href="${waLink}" target="_blank" style="background: #10b981; color: #ffffff; text-decoration: none; padding: 12px 24px; border-radius: 8px; font-weight: bold; font-size: 13px; display: inline-block;">💬 Open WhatsApp Chat with Client</a></div>` : ''}
                          <p style="color: #94a3b8; font-size: 11px; text-align: center; margin-top: 24px; margin-bottom: 0;">Connected notification email: <strong>sheminmuhammed594@gmail.com</strong></p>
                        </div>
                      </div>
                    `
                  });
                  console.log('✉️ Inquiry notification email dispatched to sheminmuhammed594@gmail.com!');
                } catch (e: any) {
                  console.error('Vite plugin inquiry email dispatch error:', e);
                }
              }
              res.statusCode = 200;
              res.setHeader('Content-Type', 'application/json');
